...
static uint64_t substitute_effort(kissat *solver) {
  return 10 * CLAUSES;
}

static bool really_substitute(kissat *solver) {
...
static bool *add_representative_equivalences(kissat *solver, unsigned *repr) {
